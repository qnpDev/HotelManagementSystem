                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="edit_payment" name="edit_payment" value="" readonly placeholder="Payment">
                                    <span class="text-danger">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="edit_magiaodich" name="edit_magiaodich" value="" readonly placeholder="Ma Giao Dich">
                                    <span class="text-danger">
                                             <strong id="show_checkin-error"></strong>
                                         </span>
                                </div>
