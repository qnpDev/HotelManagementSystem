                    ...
                    <div class="widget-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group ">
                                    <label for="checkout">Payment</label>
                                    <input type="text" class="form-control" id="show_payment" name="show_payment" value="" readonly placeholder="Payment">
                                    <span class="text-danger">
                                             <strong id="show_checkin-error"></strong>
                                         </span>
                                </div>
                                ...
                                <div class="form-group ">
                                    <label for="checkout">Mã giao dịch</label>
                                    <input type="text" class="form-control" id="show_magiaodich" name="show_magiaodich" value="" readonly placeholder="Ma Giao Dich">
                                    <span class="text-danger">
                                             <strong id="show_checkin-error"></strong>
                                         </span>
                                </div>
