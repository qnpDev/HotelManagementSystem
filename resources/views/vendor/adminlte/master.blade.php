...
<head>
    ...
    <title>Quản Lý Khách Sạn | AdminPanel</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-lg"><b>Hotel Manager</b></span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{ asset('vendor/adminlte/dist/img/avatar-default.jpg') }}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            @if (Auth::check())
                            <img src="{{ asset('vendor/adminlte/dist/img/avatar-default.jpg') }}" class="user-image" alt="User Image">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        ...
                        <li><a href="{{ route('admin.role.index') }}"><i class="fa fa-circle-o"></i> Quyền Hạn </a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        <li><a href="{{ route('admin.datphong.index') }}"><i class="fa fa-circle-o"></i> Đơn Đặt Phòng</a></li>
                        <li><a href="{{ route('admin.thuephong.index') }}"><i class="fa fa-circle-o"></i> Phòng Đã Thuê</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        ...
                        <li><a href="{{ route('admin.dichvu.index') }}"><i class="fa fa-circle-o"></i> Dịch Vụ Phòng</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        <li><a href="{{ route('admin.thongke.year') }}"><i class="fa fa-circle-o"></i> Thống kê theo năm</a></li>
                        <li><a href="{{ route('admin.thongke.month') }}/<?= date("Y") ?>"><i class="fa fa-circle-o"></i> Thống kê theo tháng</a></li>
                        <li><a href="{{ route('admin.thongke.period') }}"><i class="fa fa-circle-o"></i> Thống kê theo quý</a></li>
                        <li><a href="{{ route('admin.thongke.futuremonth') }}"><i class="fa fa-circle-o"></i> Thống kê đơn đặt tháng tới</a></li>
                    </ul>
                </li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2021 <a href="https://adminlte.io">qnp</a>.</strong>
    </footer>
