...
@yield('content')
    ...
    <footer id="footer">
                    ...
                    <div class="col-xs-12 col-lg-5">
                        <div class="widget widget_logo">
                            <div class="widget-logo">
                                ...
                                <div class="text">
                                    <p><i class="lotus-icon-location"></i> Địa chỉ</p>
                                    <p><i class="lotus-icon-phone"></i> 0123-456-789</p>
                                    <p><i class="fa fa-envelope-o"></i> <a href="mailto:qnpdev@gmail.com">qnpdev@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="footer_bottom">
            <div class="container">
                <p>&copy; 2021 qnp All rights reserved.</p>
            </div>
        </div>
        <!-- END / FOOTER BOTTOM -->
