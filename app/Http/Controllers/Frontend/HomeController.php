...
//        dd($data['phong2']);
        ...
        $data['phong'] = DB::table('phong')
            ->join('loaiphong', 'phong.loaiphong_id', '=', 'loaiphong.id')
            ->select('loaiphong.id','loaiphong.giatien','loaiphong.tenloaiphong')
            ->where('phong.tinhtrang',0)
            ->groupBy('phong.loaiphong_id')
            ->get();
    ...
    public function postReservation(Request $request){
        ...
        $valid = Validator::make($request->all(), [
            ...
            'cmnd.requỉred' => 'Vui lòng nhập CMND',
            'email.requỉed' => 'Vui lòng nhập Email',
            'payment.requỉed' => 'Vui lòng chọn phương thức Thanh toán',
            'magiaodich.requỉed' => 'Vui lòng Thanh toán',
        ]);
        if($valid->fails()){
