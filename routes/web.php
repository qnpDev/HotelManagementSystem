...
Route::group(['prefix' => 'admin','as' => 'admin.'], function (){
    ...
    Route::get('/thongke/year', 'StatisticController@year')->name('thongke.year');
    Route::get('/thongke/month/{year?}', 'StatisticController@month')->where('year','[0-9]+')->name('thongke.month');
    Route::get('/thongke/period', 'StatisticController@period')->name('thongke.period');
    Route::get('/thongke/futuremonth', 'StatisticController@futuremonth')->name('thongke.futuremonth');
...
Route::group(['as' => 'frontend.','namespace' => 'Frontend'],function(){
    ...
    Route::post('/register','HomeController@postLogin')->name('home.postregister');
    ...
    Route::get('/thongtindatphong','HomeController@checkInfoCustomer')->name('home.checkinfo');
